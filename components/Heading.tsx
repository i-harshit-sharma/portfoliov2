import { Github, Linkedin, NotepadText } from "lucide-react";
    ...
    return (
        <>
            ...
            <div className="flex justify-between items-center py-6 mx-16">
                {/* <h1 className="text-2xl font-bold text-[#f97316] tracking-wide cursor-default group">
                    <span className="inline-block text-5xl mr-2 grp">
                        <span className="group-hover:hidden">
                            👋
                        </span>
                        <div className="hidden group-hover:block">
                            <Image src="/hi.webp" height={64} width={64} className="w-12 h-12" alt="hi animated logo" aria-hidden />
                        </div>
                    </span>
                    <span className="">
                        Hello
                        <span className="inline-block w-0 group-hover:w-16 overflow-hidden transition-all duration-500  align-bottom">
                            oooo
                        </span>
                    </span>
                    !
                </h1> */}
                <h1 className="text-2xl font-bold text-[#f97316] tracking-wide cursor-default group flex items-center">
                    {/* Icon Container: Relative positioning to hold the absolute children */}
                    <span className="relative inline-flex items-center justify-center w-12 h-12 mr-2">

                        {/* The Emoji: Fades and scales down on hover */}
                        <span className="absolute text-5xl transition-all duration-300 ease-out group-hover:opacity-0 group-hover:scale-50 group-hover:-rotate-12">
                            👋
                        </span>

                        {/* The Image: Fades and scales up on hover */}
                        <div className="absolute opacity-0 scale-50 rotate-12 transition-all duration-300 ease-out group-hover:opacity-100 group-hover:scale-100 group-hover:rotate-0">
                            <Image
                                src="/hi.webp"
                                height={64}
                                width={64}
                    ...
                    <span className="flex items-baseline">
                        Hello
                        {/* Expanding 'oooo': Added whitespace-nowrap and ease-out */}
                        <span className="inline-block w-0 group-hover:w-[2.2em] overflow-hidden transition-all duration-500 ease-out whitespace-nowrap">
                            oooo
                        </span>
                        !
                    </span>
