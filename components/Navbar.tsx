...
export default function Navbar() {
    return (
        <div className="hidden fixed bottom-6 right-0 left-0 w-fit gap-1 max-w-2xl mx-auto rounded-full p-1 sm:flex justify-between items-center font-medium bg-[#222222cc] text-sm text-white z-50 menu-bar border border-white/10 shadow-lg">
